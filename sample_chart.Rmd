...
```{r, echo=F}
ud %>% count(満足度) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>%  kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
round(ud.csd[,-(3:4)], 1) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
```{r, echo=F}
ud %>% count(性別) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
```{r, echo=F}
ud %>% count(年齢) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
```{r, echo=F}
ud %>% count(来店曜日) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
```{r, echo=F}
ud %>% count(来店時間) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
```{r, echo=F}
ud %>% count(来店店舗) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
```{r, echo=F}
ud %>% count(レジ) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
```{r, echo=F}
ud %>% count(売り場) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
```{r, echo=F}
ud %>% count(試着室) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
```{r, echo=F}
ud %>% count(裾直し) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
...
```{r, echo=F}
ud %>% count(陳列) %>% mutate(pct = percent( n / sum(n) %>% round(2), 1)) %>% kable() %>% kable_styling(full_width = F, position = "center", bootstrap_options = c("striped", "hover"))
```
